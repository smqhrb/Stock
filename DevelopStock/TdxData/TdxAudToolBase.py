...
class Ui_Dialog(QtWidgets.QWidget):
    def setupUi(self, Dialog):
        ...
        self.cb_MACD = QtWidgets.QCheckBox(self.tab_view)
        self.cb_MACD.setGeometry(QtCore.QRect(10, 316, 44, 16))
        self.cb_MACD.setObjectName("cb_MACD")
        self.cb_slopeMA5 = QtWidgets.QCheckBox(self.tab_view)
        self.cb_slopeMA5.setGeometry(QtCore.QRect(80, 386, 71, 16))
        self.cb_slopeMA5.setObjectName("cb_slopeMA5")
        self.cb_nhd_20_31_60 = QtWidgets.QCheckBox(self.tab_view)
        self.cb_nhd_20_31_60.setGeometry(QtCore.QRect(10, 338, 113, 16))
        self.cb_nhd_20_31_60.setObjectName("cb_nhd_20_31_60")
        self.cb_MA5 = QtWidgets.QCheckBox(self.tab_view)
        self.cb_MA5.setGeometry(QtCore.QRect(10, 386, 53, 16))
        ...
        self.cb_MA10 = QtWidgets.QCheckBox(self.tab_view)
        self.cb_MA10.setGeometry(QtCore.QRect(10, 403, 53, 16))
        self.cb_MA10.setObjectName("cb_MA10")
        self.cb_MA20 = QtWidgets.QCheckBox(self.tab_view)
        self.cb_MA20.setGeometry(QtCore.QRect(10, 420, 53, 16))
        self.cb_MA20.setObjectName("cb_MA20")
        self.cb_MA31 = QtWidgets.QCheckBox(self.tab_view)
        self.cb_MA31.setGeometry(QtCore.QRect(10, 436, 53, 16))
        self.cb_MA31.setObjectName("cb_MA31")
        self.cb_MA60 = QtWidgets.QCheckBox(self.tab_view)
        self.cb_MA60.setGeometry(QtCore.QRect(10, 453, 53, 16))
        self.cb_MA60.setObjectName("cb_MA60")
        self.cb_MA120 = QtWidgets.QCheckBox(self.tab_view)
        self.cb_MA120.setGeometry(QtCore.QRect(10, 470, 53, 16))
        self.cb_MA120.setObjectName("cb_MA120")
        self.cb_slopeMA10 = QtWidgets.QCheckBox(self.tab_view)
        self.cb_slopeMA10.setGeometry(QtCore.QRect(80, 403, 71, 16))
        self.cb_slopeMA10.setObjectName("cb_slopeMA10")
        self.cb_slopeMA20 = QtWidgets.QCheckBox(self.tab_view)
        self.cb_slopeMA20.setGeometry(QtCore.QRect(80, 420, 71, 16))
        self.cb_slopeMA20.setObjectName("cb_slopeMA20")
        self.cb_slopeMA31 = QtWidgets.QCheckBox(self.tab_view)
        self.cb_slopeMA31.setGeometry(QtCore.QRect(80, 436, 71, 16))
        self.cb_slopeMA31.setObjectName("cb_slopeMA31")
        self.cb_slopeMA60 = QtWidgets.QCheckBox(self.tab_view)
        self.cb_slopeMA60.setGeometry(QtCore.QRect(80, 453, 71, 16))
        self.cb_slopeMA60.setObjectName("cb_slopeMA60")
        self.cb_slopeMA120 = QtWidgets.QCheckBox(self.tab_view)
        self.cb_slopeMA120.setGeometry(QtCore.QRect(80, 470, 71, 16))
        self.cb_slopeMA120.setObjectName("cb_slopeMA120")
        self.cb_BOLL = QtWidgets.QCheckBox(self.tab_view)
        self.cb_BOLL.setGeometry(QtCore.QRect(79, 316, 44, 16))
        self.cb_BOLL.setObjectName("cb_BOLL")
        self.cb_nhd31_60_120 = QtWidgets.QCheckBox(self.tab_view)
        self.cb_nhd31_60_120.setGeometry(QtCore.QRect(10, 356, 113, 16))
        ...
        self.cb_kLine = QtWidgets.QCheckBox(self.tab_view)
        self.cb_kLine.setGeometry(QtCore.QRect(10, 296, 51, 16))
        self.cb_kLine.setObjectName("cb_kLine")
        self.cb_volume = QtWidgets.QCheckBox(self.tab_view)
        self.cb_volume.setGeometry(QtCore.QRect(80, 296, 61, 16))
        self.cb_volume.setObjectName("cb_volume")
        self.btn_getValue = QtWidgets.QPushButton(self.tab_view)
        self.btn_getValue.setGeometry(QtCore.QRect(10, 132, 191, 31))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.btn_getValue.setText(_translate("Dialog", "从数据库读取数据"))
